...
namespace Chip
{
    public class BossFromRock2 : Enemy
    {
        ...
        public BossFromRock2()
        {
            Health = 24;
            Points = 1;
            AvatarPath = "boss_from_rock2_avatar";
            ...
            // collider
            MoveCollider = Add(new Hitbox(-24, -19, 48, 43));
        ...
        public override void DyingEnd()
        {
            ...
            var cut = new CS331_RockBossKilled
            {
